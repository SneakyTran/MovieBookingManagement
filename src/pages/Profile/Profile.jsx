...
import "./profile.css"
import { getUserInfoAction, updateUser, updateUserAction } from '../../redux/actions/FormAction';
                ...
                <div className="row gutters">
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div className="form-group">
                      ...
                      <input value={formik.values.matKhau} onChange={formik.handleChange} type="text" className="form-control" id='matKhau' name='matKhau' placeholder="Enter your password" />
                    </div>
                  </div>
                </div>
                <div className="row gutters">
